...
function cekKetersediaanLapangan($conn, $lapangan_id, $tanggal, $jam_mulai, $durasi, $exclude_id = null) {
    ...
    // Query SELECT untuk ambil booking yang ada
    ...
    // Eksekusi query - sesuai materi: mysqli_query()
    $result = mysqli_query($conn, $query);
    $nomor_terpakai = array();
    
    // Fetch data - sesuai materi: mysqli_fetch_array()
    ...
    // Tentukan nomor lapangan yang tersedia
 ...
 * Sesuai materi: fungsi terpisah untuk perhitungan
 */
function hitungTotalSewa($conn, $lapangan_id, $durasi, $jml_raket) {
    // Query SELECT untuk ambil harga
