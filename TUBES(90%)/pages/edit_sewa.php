...
// 4. Tahap 1: Ambil data yang akan diedit
// Sesuai materi: "Pertama menyediakan data yang ingin diedit"
...
// 5. Ambil daftar lapangan
$query_lapangan = "SELECT * FROM lapangan";
$result_lapangan = mysqli_query($conn, $query_lapangan);

// 6. Tahap 3: Proses UPDATE
// Sesuai materi: "Ketiga melakukan proses modifikasi"
    ...
    if (empty($lapangan_id) || empty($tanggal) || empty($jam) || $durasi < 1) {
        ...
        if ($tanggal < $today) {
            ...
            if (!$validasi_jam['valid']) {
                ...
                // Cek ketersediaan (exclude booking ini)
                ...
                if (empty($nomor_tersedia)) {
                    ...
                    // Gunakan nomor yang sama jika masih tersedia
                    ...
                    // UPDATE data
                    // Sesuai materi: query UPDATE untuk memodifikasi data
                    $sql = "UPDATE sewa SET 
...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <!-- Tahap 2: Interface untuk modifikasi -->
        <div class="info-box">
